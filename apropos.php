        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="https://thecleaureliea.promo-24.codeur.online/Portfolio/">Réalisations<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="https://thecleaureliea.promo-24.codeur.online/Portfolio/apropos.php">A propos</a>
            </li>
            <li class="nav-item active">
